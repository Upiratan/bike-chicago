...
def count_user_type(data_list):
    ...
    """
      Função de exemplo com anotações.
      Argumentos:
          param1: Lista de tipos de usuários.
      Retorna:
          Contagem de Customer e Subscriber.
...
answer = "A condição é Falsa porque temos linhas vazias na coluna dos gêneros, fazendo com que a soma dos termos não seja igual ao comprimento da coluna."
...
# Tive problemas na mediana. Acabei tendo que recorrer a publicação no slack para conseguir fazer.
...
print("Min: ", round(min_trip), "Max: ", round(max_trip), "Média: ", round(mean_trip), "Mediana: ", round(median_trip))
